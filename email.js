...
exports.resetPasswordSuccessfulTemplate = (data)=> {
    return `
        <!DOCTYPE html>
<html lang="en">
<head>
                        ...
                        <tr>
                            <td class="content" style="padding: 40px; text-align: center; color: #333333;">
                                ...
                                <p style="font-size: 16px; line-height: 1.5; margin: 0 0 30px; color: #666666;">
                                    Hi ${data.name}, your password for <strong>NEW AGE PLC</strong> has been successfully updated. You can now log back into your account using your new credentials.
                                </p>
